...
from .structure import PreActivation, PostActivation, MidActivation
...
class MidActivationND(MidActivation):
    """
    Performs a sequence of activation, convolution and batch_norm:

        in -> (activation -> Conv -> BN) -> out
...
MidActivation1d = partial(MidActivationND, conv_module=nn.Conv1d, batch_norm_module=nn.BatchNorm1d)
MidActivation2d = partial(MidActivationND, conv_module=nn.Conv2d, batch_norm_module=nn.BatchNorm2d)
MidActivation3d = partial(MidActivationND, conv_module=nn.Conv3d, batch_norm_module=nn.BatchNorm3d)
